        ...
        return [
          {
            ...
            text: (
              <>
                ...
                <br /> з увагою і любов'ю до своєї справи.
              </>
            ),
          },
          {
            ...
            text: (
              <>
                ...
                <br /> Я враховую всі твої побажання,
                <br /> тип волосся і стиль життя, щоб створити ідеальний вигляд.
              </>
            ),
          },
          {
            ...
            text: (
              <>
                Я вірю, що в світі краси завжди можна розвиватися,
                <br /> тому щороку я беру участь у курсах підвищення
                кваліфікації.
                <br /> Моя знання включає останні техніки,
          ...
          },
          {
            ...
            text: (
              <>
                ...
                <br /> а й дбати про здоров'я твоїх волосся і шкіри голови.
              </>
            ),
          },
          {
            ...
            text: (
              <>
                Твоє здоров'я та безпека — це моя пріоритет.
                <br /> Я суворо дотримуюся всіх норм щодо
                <br /> дезінфекції та стерилізації інструментів,
                <br /> щоб ти міг почуватися комфортно та безпечно.
              </>
            ),
          },
        ];
